...
После слияния веток в случае если разнится информация может возникнуть конфликт. Для его решения нужно просмотреть всю информацию и оставить только нужную. 
