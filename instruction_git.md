...
Слияние веток происходит при помощи команды:

    git merge branch_name

branch_name - название ветки, которую нужно присоединить.    

Важно при выполнении команды находиться в той ветке, в которую нужно добавить информацию. 

#### Разрешение конфликта

<<<<<<< HEAD
После слияния веток в случае если разнится информация может возникнуть конфликт.
=======
После слияния веток в случае если разнится информация может возникнуть конфликт. Для его решения нужно оставить необходимую информацию и удалить ненужную. После этого сделать коммит.
>>>>>>> conflict_resolution
